<template>
    <div class="space-y-10">
        ...
        <!-- coach lists -->
        <div class="border dark:border-gray-100/10 h-fit rounded-md p-5 flex flex-col gap-y-5">
            <h1 class="text-lg font-bold">Coach lists</h1>
            <div class="bg-gray-100 dark:bg-gray-100/10 p-5 rounded-md">
                <div class="bg-gray-100 dark:bg-gray-100/10 p-5 rounded-md">
                    <table class="min-w-[500px] md:w-full font-inter tracking-wide">
                        <thead>
                        ...
                        <tbody v-if="coaches.length">
                            <tr class="text-md" v-for="(coach, index) in coaches" :key="index">
                                <td class="p-2 border border-gray-300 dark:border-gray-100/10">
                                    <div class="flex gap-x-3">
                                        <img :src="coach?.photoUrl" alt="school logo" class="w-20 aspect-square bg-gray-200 dark:bg-gray-100/10 p-2 rounded">
                                        <router-link :to="{ name: 'coachDetails', params: { id: coach.id } }" class="flex flex-col justify-center">
