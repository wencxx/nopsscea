    ...
    <div class="flex items-center justify-center h-screen w-screen fixed -top-10 left-0 bg-black/10 z-10">
        <form @submit.prevent="submitForm" class="bg-white w-11/12 lg:w-[40dvw] !h-[90dvh] overflow-auto rounded-md lg:grid grid-cols-2 gap-3 p-5 relative">
            ...
            <div class="flex flex-col h-fit gap-y-1">
                ...
                <input type="text" class="border rounded h-10 lg:h-8 pl-2" v-model="formData.schoolName">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
            ...
            <div class="flex flex-col h-fit gap-y-1">
                ...
                <input type="text" class="border rounded h-10 lg:h-8 pl-2" v-model="formData.sport">
            </div>
            ...
            <div class="flex flex-col h-fit gap-y-1">
                ...
                <input type="text" class="border rounded h-10 lg:h-8 pl-2" v-model="formData.fathersName">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
                <label>E-Signature</label>
                <input type="file" accept=".jpg, .png, .jpeg" class="h-10 lg:h-8" @change="handleImageUpload($event, 'fEsign')">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
                <label>Mothers Name</label>
                <input type="text" class="border rounded h-10 lg:h-8 pl-2" v-model="formData.mothersName">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
                <label>E-Signature</label>
                <input type="file" accept=".jpg, .png, .jpeg" class="h-10 lg:h-8" @change="handleImageUpload($event, 'mEsign')">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
                <label>Guardians Name</label>
                <input type="text" class="border rounded h-10 lg:h-8 pl-2" v-model="formData.guardianName">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
                <label>E-Signature</label>
                <input type="file" accept=".jpg, .png, .jpeg" class="h-10 lg:h-8" @change="handleImageUpload($event, 'gEsign')">
            </div>
            <div class="flex flex-col h-fit gap-y-1">
